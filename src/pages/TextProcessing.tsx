      ...
      <div className="flex h-[calc(100vh-64px)]">
        ...
        <div className="w-80 border-r bg-card/30 backdrop-blur-sm flex flex-col">
          ...
          <div className="p-6 border-b">
            ...
            <Button className="w-full gap-2" onClick={() => {setActiveItem(null); setActiveType(null);}}>
          ...
          {!activeItem ? (
            ...
            <div className="flex-1 p-8">
              <div className="max-w-6xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <Card className="bg-gradient-to-r from-green-500/10 to-green-600/10 border-green-500/20">
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-2xl font-bold text-green-600">{contentPresets.length}</p>
                      </CardContent>
                    </Card>
                ...
                <div className="mb-12">
                  <h2 className="text-2xl font-bold mb-6">Processing Tools</h2>
                        ...
                        >
                          <CardContent className="p-6">
                            <div className="flex items-start justify-between mb-4">
                              <div className={`p-3 rounded-xl bg-gradient-to-r ${model.color} shadow-lg group-hover:scale-110 transition-transform`}>
