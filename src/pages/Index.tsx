        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Transform your audio and text in three simple steps
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: "Upload audio files, enter text, or import Excel spreadsheets with your content."
                },
                {
                  step: "02",
                  title: "Configure Options",
                  description: "Select target language, voice, and other customization options."
                },
                {
                  step: "03",
                  title: "Download Results",
                  description: "Receive high-quality audio output in your preferred format."
                }
              ].map((item, index) => (
      ...
      <div className="py-24 bg-gradient-to-b from-muted/30 to-background">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center mb-16">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              VocalVerse helps a wide range of users unlock new possibilities with AI voice technology
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Create narration in multiple languages, clone your voice for consistent branding, and convert scripts to professional audio.",
                benefits: [
              ...
              },
              {
                ...
                description: "Transform learning materials into engaging audio resources, create accessible content, and develop multilingual courses.",
                benefits: [
              ...
              {
                title: "Businesses",
                description: "Produce professional voice content for presentations, convert data reports to speech, and create consistent brand voice assets.",
                benefits: [
                  "Professional voice for presentations",
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">VocalVerse</span>
              </div>
          ...
          <div className="mt-12 border-t border-gray-800 pt-8 text-center">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} VocalVerse. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
