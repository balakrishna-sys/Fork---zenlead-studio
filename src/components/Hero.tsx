          ...
          <div className="mx-auto mt-12 lg:mt-20 grid max-w-4xl grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-3 px-4">
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-primary/20 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardContent className="p-6 text-center">
                <div className="mx-auto h-12 w-12 rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 p-3 mb-4">
                  <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <p className="mt-2 text-sm text-muted-foreground">Create stunning videos from text descriptions</p>
              </CardContent>
            </Card>

            <Card className="bg-card/50 backdrop-blur-sm border-primary/20 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardContent className="p-6 text-center">
                <div className="mx-auto h-12 w-12 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 p-3 mb-4">
                  <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0-1.125.504-1.125 1.125V11.25a9 9 0 0 0-9-9Z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-foreground">Smart Documents</h3>
                <p className="mt-2 text-sm text-muted-foreground">AI-powered resume analysis and optimization</p>
              </CardContent>
            </Card>
          </div>
        </div>
